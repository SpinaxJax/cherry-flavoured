...
public class ModBlockLootTableProvider extends FabricBlockLootSubProvider {
    ...
    public void generate() {
        ...
        add(ModBlocks.SILVER_ORE, createMultipleOreDrops(ModBlocks.SILVER_ORE, ModItems.RAW_SILVER, 1, 3));
        add(ModBlocks.DEEPSLATE_SILVER_ORE, createMultipleOreDrops(ModBlocks.DEEPSLATE_SILVER_ORE, ModItems.RAW_SILVER, 2, 4));
